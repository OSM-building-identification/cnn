...
def conv2d_bn(x, nb_filter, nb_row, 
              nb_col,
    ...
    Adapted from https://github.com/fchollet/deep-learning-models/blob/master/inception_v3.py
    ...
    conv_name = None
    bn_axis = 1
    x = Convolution2D(nb_filter, nb_row, 
                      nb_col,
                      subsample=subsample,
                      activation='relu',
...
(X_train, Y_train), (X_valid, Y_valid) = load.load_data()
 ...
 model.fit(X_train, Y_train,
          ...
          shuffle=True,
          verbose=1,
          validation_data=(X_valid, Y_valid), #dim
          )
